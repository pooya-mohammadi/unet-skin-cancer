...
def model_generalization(model: tensorflow.keras.models, test_loader: DataGenerator, double_unet=False,
    ...
    y_predict = model.predict(new_frame_x)[..., channel]
    ...
    ax2.imshow(np.squeeze(new_frame_y[...,channel][0]))
