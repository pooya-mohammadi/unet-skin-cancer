...
def UnetRes50():
    ...
    parser.add_argument("--rotation_range", type=int, default=30, help='Range of rotation of images')
    ...
    parser.add_argument("--horizontal_flip", type=bool, default=True, help='Whether flip horizontally or not')
